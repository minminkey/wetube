...
var _undefsafe = _interopRequireDefault(require("undefsafe"));
...
var githubLoginCallback = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(accessToken, _, profile, cb) {
    var _profile$_json, id, avatarUrl, name, emails, promise;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            emails = (0, _undefsafe["default"])(profile, "emails.0.value");
            promise = null;
            ...
            if (emails) {
              ...
              promise = new Promise(function (resolve, reject) {
                (0, _request["default"])({
                  ...
                  resolve(body.find(function (entry) {
...
var kakaoLoginCallback = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(_, __, profile, cb) {
    var id, name, _profile$_json2, profileImg, email, user, newUser;

    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            id = profile.id, name = profile.username, _profile$_json2 = profile._json, profileImg = _profile$_json2.properties.profile_image, email = _profile$_json2.kakao_account.email;
            _context4.prev = 1;
            _context4.next = 4;
            return _User["default"].findOne({
              email: email
  ...
  return function kakaoLoginCallback(_x9, _x10, _x11, _x12) {
...
var getMe = /*#__PURE__*/function () {
  ...
  return function getMe(_x13, _x14) {
...
var userDetail = /*#__PURE__*/function () {
  ...
  return function userDetail(_x15, _x16) {
...
var postEditProfile = /*#__PURE__*/function () {
  ...
  return function postEditProfile(_x17, _x18) {
...
var postChangePassword = /*#__PURE__*/function () {
  ...
  return function postChangePassword(_x19, _x20) {
